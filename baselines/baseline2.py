...
def main():
    ...
    # Output layout: results/<hospital>/search/baseline2/<task>/{baseline2_search,baseline2_best}.csv
    output_dir = Path(args.results_dir) / args.hospital / "search" / "baseline2" / args.task
    output_dir.mkdir(parents=True, exist_ok=True)
    csv_path = output_dir / "baseline2_search.csv"
